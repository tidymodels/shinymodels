      ...
      shinydashboard::dashboardBody(
        shinydashboard::tabItems(
          ...
          shinydashboard::tabItem(
            tabName = "interactive",
            shiny::fluidRow(
              shinydashboard::box(plotly::plotlyOutput("obs_vs_pred"),
                solidHeader = T, collapsible = T,
                title = "Observed vs. Predicted", status = "primary", collapsed = T
              ),
              shinydashboard::box(plotly::plotlyOutput("resid_vs_pred"),
                solidHeader = T, collapsible = T,
              ...
              if (length(num_columns) == 0) {
                ...
                shinydashboard::box(plotly::plotlyOutput("resid_vs_numcol"),
                  solidHeader = T, collapsible = T,
              ...
              if (length(fac_columns) == 0) {
                ...
                shinydashboard::box(plotly::plotlyOutput("resid_vs_factorcol"),
                  solidHeader = T, collapsible = T,
